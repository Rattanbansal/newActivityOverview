...
if (sizeoflisting > 2) {
        ...
        for (refund = 1; refund < SizeofActiveBookings; refund++) {
				...
				if (WebUI.waitForElementVisible(findTestObject('Object Repository/DetailPop-up/MoreActions/MoreOptionSelect'), 15) == true) {
					...
					if (WebUI.waitForElementVisible(findTestObject('Object Repository/DetailPop-up/MoreActions/MoreAction-SelectOptions', [('action') : 'Refund']), 15) == true) {
					
					WebUI.click(findTestObject('Object Repository/DetailPop-up/MoreActions/MoreAction-SelectOptions', [('action') : 'Refund']))
					...
					WebUI.setText(findTestObject('Object Repository/DetailPop-up/MoreActions/RefundReason'), GlobalVariable.CancellationReason)
					
					WebUI.delay(1)
					
					WebUI.takeScreenshot()
					
					WebUI.click(findTestObject('Object Repository/DetailPop-up/MoreActions/confirmRefundOrder'))
					...
					if (WebUI.waitForElementVisible(findTestObject('Object Repository/DetailPop-up/MoreActions/CancelRefundButton'), 15) == true) {
						
						WebUI.click(findTestObject('Object Repository/DetailPop-up/MoreActions/CancelRefundButton'))
