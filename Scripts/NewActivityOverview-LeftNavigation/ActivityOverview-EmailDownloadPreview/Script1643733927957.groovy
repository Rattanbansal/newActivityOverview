...
if (sizeoflisting > 2) {
	...
	for (l = 1; l <= paginationmaxcount; l++) {
		...
		WebUI.takeScreenshot()
			...
			if (WebUI.waitForElementClickable(findTestObject('Object Repository/Header/Preview/ClickOnPreviewIcon'), 15) == true) {
		    ...
		    String UrlToClick = WebUI.findWebElement(findTestObject(
		            'Object Repository/Header/CopyUrl/CopyUrl')).getAttribute(
		        'data-href_url')
		
		    println(UrlToClick)
		
		    GlobalVariable.ActivityUrl = UrlToClick
			...
			WebUI.callTestCase(findTestCase('Test Cases/NewActivityOverview-LeftNavigation/ActivityOverview-EmailDownloadPreview-CopiedURL'),
