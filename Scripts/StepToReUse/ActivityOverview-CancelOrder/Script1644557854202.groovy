...
KeywordUtil.logInfo("Refund Value: ${GlobalVariable.refundvalue}")
                ...
                if (WebUI.waitForElementClickable(findTestObject('Object Repository/CancelAndRefund/CancelOrderButton'), 15) == true) {
						
					WebUI.scrollToElement(findTestObject('Object Repository/CancelAndRefund/CancelOrderButton'), 15)
                        WebUI.click(findTestObject('Object Repository/CancelAndRefund/CancelOrderButton'))
                        WebUI.delay(3)
